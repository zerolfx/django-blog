# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-07-03 09:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.CharField(blank=True, max_length=140, null=True, verbose_name='摘要')),
        ...
        migrations.AddField(
            model_name='article',
            name='catagory',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='blog.Catagory', verbose_name='分类'),
        ),
    ]
